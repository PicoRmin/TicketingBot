...
- [x] ایجاد مدل‌های SQLAlchemy:
  ...
  - [x] Ticket (تیکت‌ها)
  - [x] Branch (شعبه‌ها)
  - [x] TicketHistory (تاریخچه)
  - [x] Attachment (فایل‌های پیوست)
  - [x] Comment (نظرات)
- [x] ایجاد Migration سیستم (اسکریپت‌های سفارشی و Alembic-ready setup)
- [x] ایجاد Seed Data برای تست
- [x] ایجاد Indexes برای بهینه‌سازی
- [x] ایجاد اسکریپت‌های مهاجرت دیتابیس (SQLite migration scripts)
...
**مدت زمان تخمینی: ۳-۴ روز** | **وضعیت: تکمیل شده (Production Ready)**

- [x] ایجاد endpoint برای آپلود فایل
- [x] اعتبارسنجی نوع و اندازه فایل (قابل تنظیم از تنظیمات سیستم)
- [x] اعتبارسنجی تعداد فایل‌ها (حداکثر ۱۰ عکس و ۵ فایل متنی - قابل تنظیم)
- [x] ذخیره‌سازی فایل‌ها (Local storage)
- [x] اعتبارسنجی فایل در بات تلگرام (قبل از دانلود و آپلود)
- [x] بهبود مدیریت خطا و لاگینگ برای آپلود فایل
- [x] ایجاد endpoint برای دانلود فایل
- [x] ایجاد endpoint برای لیست فایل‌های یک تیکت
- [x] ایجاد endpoint برای حذف فایل (فقط ادمین)
- [x] سیستم تنظیمات فایل (قابل مدیریت از پنل ادمین)
- [x] بهبود error handling و logging
- [x] پیام‌های خطای فارسی و انگلیسی
- [x] مدیریت دسترسی به فایل‌ها
- [ ] ذخیره‌سازی فایل‌ها (S3) - برای نسخه‌های بعدی
- [ ] سیستم مدیریت فایل‌های قدیمی - برای نسخه‌های بعدی
- [ ] فشرده‌سازی تصاویر (اختیاری) - برای نسخه‌های بعدی

### فاز ۶: ربات تلگرام / Phase 6: Telegram Bot ✅
**مدت زمان تخمینی: ۶-۸ روز** | **وضعیت: تکمیل شده (Production Ready)**

- [x] راه‌اندازی ربات تلگرام با python-telegram-bot
- [x] پیاده‌سازی Handlers:
  - [x] /start - شروع ربات
  - [x] /new_ticket - ایجاد تیکت جدید
  - [x] /my_tickets - مشاهده تیکت‌های من
  - [x] /track_ticket - پیگیری تیکت
  - [x] /help - راهنما
  - [x] /login - ورود به سیستم
  - [x] /logout - خروج از سیستم
- [x] سیستم انتخاب زبان (فارسی/انگلیسی)
- [x] ایجاد Conversation Handler برای ایجاد تیکت
- [x] سیستم دریافت فایل از تلگرام
- [x] اعتبارسنجی فایل قبل از آپلود
- [x] نمایش وضعیت تیکت به صورت زیبا
- [x] سیستم اعلان برای تغییر وضعیت تیکت (در فاز 10 تکمیل شد)
- [x] بهبود error handling و logging
- [x] مدیریت Session برای کاربران
- [x] Lifecycle Management (شروع و توقف صحیح)
...
- [x] ترجمه تمام پیام‌های سیستم (API اصلی + Bot)
- [x] ترجمه پیام‌های خطا
- [ ] ترجمه گزارش‌ها (در فاز گزارش‌گیری تکمیل می‌شود)

### فاز ۸: پنل وب مدیریتی / Phase 8: Web Admin Panel ✅
**مدت زمان تخمینی: ۸-۱۰ روز** | **وضعیت: تکمیل شده (MVP)**

- [x] انتخاب Framework Frontend (React + TypeScript + Vite)
- [x] ایجاد صفحه Login
- [x] ایجاد Dashboard با آمار کلی (ساده)
- [x] صفحه لیست تیکت‌ها با Pagination اولیه
- [x] فیلتر و جستجو (اولیه)
- [x] صفحه جزئیات تیکت
- [x] امکان تغییر وضعیت تیکت (ادمین)
- [x] امکان افزودن نظر/پاسخ به تیکت
- [x] صفحه مدیریت کاربران (ایجاد/ویرایش/حذف، نقش‌ها، شعب)
- [x] صفحه مدیریت شعبه‌ها (لیست و افزودن)
- [x] Responsive Design
- [x] Dark Mode (اختیاری)
...
- [x] سیستم اعلان برای تغییر وضعیت تیکت
- [x] ارسال اعلان از طریق تلگرام
- [ ] ارسال اعلان از طریق ایمیل (اختیاری)
- [ ] تنظیمات اعلان برای کاربران
- [x] اعلان برای ادمین‌ها هنگام تیکت جدید
...
**آخرین به‌روزرسانی / Last Updated**: 2025-11-12
**نسخه / Version**: 1.0.1
